    ...
    nestedItems={[
      ...workouts.map(workout => (
        <WorkoutListItem
          ...
          onDeleteExerciseAproachByIndex={feedIndex => onDeleteExerciseAproachByIndexAndWorkoutDate(workout.date, feedIndex)}
          addExerciseAproach={() => addExerciseAproachToWorkout(workout.date)}
          onUpdateExerciseAproachByIndex={(exerciseAproach, feedIndex) => updateExerciseAproachByIndexWorkoutDate(workout.date, exerciseAproach, feedIndex)}
        />
      )),
